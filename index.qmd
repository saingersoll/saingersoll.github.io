...
In 2025 contracted as a Project Lead and Geospatial Data Analyst for two consecutive projects at NASA's Jet Propulsion Laboratory. I have had the unique opportunity to actively contribute to forward-thinking projects geared towards informing conservation interventions and land management decisions. I have a learned experience developing geospatial workflows for a variety of geo-data types. As well as a foundational understanding of working with machine learning in tandem with satellite and remote sensing materials, both of which I am excited to utilize. My interests lie in strengthening climate adaptation and resilience in vulnerable communities by supporting clean energy, resource management, extreme hazard preparation/recovery, and pollution mitigation projects. I hope to continue participating in projects that elicit real and meaningful change. ![](images/orbit.png){width="30"}

------------------------------------------------------------------------

## Experience

![](images/clipboard-678023564.png){width="20"} **Machine Learning Data Engineer &** **GIS Analyst** \| 6/25 - 8/25 \|\
